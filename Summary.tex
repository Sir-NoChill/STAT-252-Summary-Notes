...
Note that population inferences only apply to the population of interest.
\begin{markdown}
...
\begin{answer}
    ...
    We cannot make causal inferences because assignment to the groups is not random. This is an observational study
\end{answer}
